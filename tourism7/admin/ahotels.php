...
<div class="modal fade" id="addUserModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="./hotel-sub.php" method="POST" enctype="multipart/form-data">
            <div class="modal-body">

                        <div class="form-group">
                            <label for="" >Hotel Name</label>
                            <input type="text" name="place-name" class="form-control" placeholder="Place Name">
                        </div>
                        
                        <div class="form-group">
                            <label for="" >Hotel Id</label>
                            <input type="text" name="state-id" class="form-control" placeholder="State ID">
                        </div>
                        <div class="form-group">
...
<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exaModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="./hotels-sub.php" method="POST">
            <div class="modal-body">
...
<div class="card">
                ...
                <div class="card-body">
                    ...
                    <tbody>
                    <?php 
                    $query2=mysqli_query($conn,"Select * from login.hotels");
                    $hotelcount=mysqli_num_rows($query2);
                    if($hotelcount>0)
                    {
                        while($row1=mysqli_fetch_array($query2)) { ?>
                    <tr>
                        <td><?php echo $row1['hotel_id'];?></td>
                        <td><?php echo $row1['hotel_name'];?> </td>
                        <td><?php echo $row1['image'];?> </td>
                        <td> <?php echo $row1['state_id'];?></td>
                        <td><?php echo $row1['description'];?> </td>
                        <td> <a href="hotels-edit.php?place_id=<?php echo $row1['hotel_id'];?>" class="btn btn-info btn-sm">Edit </a> 
                        <button type="button" value="<?php echo $row1['hotel_id'];?>" class="btn btn-danger btn-sm deebtn"> Delete </button>
                        </td>
