...
<div class="card">
                ...
                <div class="card-body">
                    ...
                    <tbody>
                    <?php 
                    $query2=mysqli_query($conn,"Select * from login.places");
                    $placecount=mysqli_num_rows($query2);
                    if($placecount>0)
                    {
                        while($row1=mysqli_fetch_array($query2)) { ?>
                    <tr>
                        <td><?php echo $row1['places_id'];?></td>
                        <td><?php echo $row1['name'];?> </td>
                        <td><?php echo $row1['image'];?> </td>
                        <td> <?php echo $row1['state_id'];?></td>
                        <td><?php echo $row1['description'];?> </td>
                        <td> <a href="places-edit.php?place_id=<?php echo $row1['places_id'];?>" class="btn btn-info btn-sm">Edit </a> 
                        <button type="button" value="<?php echo $row1['places_id'];?>" class="btn btn-danger btn-sm deebtn"> Delete </button>
                        </td>
